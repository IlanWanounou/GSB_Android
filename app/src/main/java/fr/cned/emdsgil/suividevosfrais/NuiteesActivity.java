...
public class NuiteesActivity extends AppCompatActivity {
	...
	private void valoriseProprietes() {
		...
		((EditText)findViewById(R.id.txtNuitees)).setKeyListener(null);
	}
    ...
    private void cmdPlus_clic() {
    	findViewById(R.id.cmdNuiteesPlus).setOnClickListener(new Button.OnClickListener() {
    		public void onClick(View v) {
    			qte+=10 ;
    			enregNewQte() ;
    		}
    ...
    private void cmdMoins_clic() {
    	findViewById(R.id.cmdNuiteesMoins).setOnClickListener(new Button.OnClickListener() {
    		public void onClick(View v) {
    ...
    private void dat_clic() {   	
    	final DatePicker uneDate = (DatePicker) findViewById(R.id.datNuitees);
